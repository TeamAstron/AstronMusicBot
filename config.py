...
BOT_NAME = getenv("BOT_NAME", "Astron Music")
...
BOT_USERNAME = getenv("BOT_USERNAME", "Astronmusicbot")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "Astronassistant")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "AstronSupport")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "TeamAstron")
# isi dengan username kamu tanpa simbol @
OWNER_NAME = getenv("OWNER_NAME", "AstronXd")
# fill with your nickname
ALIVE_NAME = getenv("ALIVE_NAME", "Astron")
...
UPSTREAM_REPO = os.environ.get(
    "UPSTREAM_REPO", "https://github.com/TeamAstron/AstronMusicBot"
)
